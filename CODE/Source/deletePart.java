...
public class deletePart extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
		    ...
		    pw.println("<body><br><br><br><form name=deletePart method=post action='http://peers:8080/servlet/showPart1')");
        	v=P.allParts();
		    pw.println("<table align='center' border=0> <tr><td>");
			pw.println("Select Part ID To Delete</td><td><SELECT id=select1 name=pid style='HEIGHT: 22px; LEFT: 74px; TOP: 222px; WIDTH: 155px'>"); 
