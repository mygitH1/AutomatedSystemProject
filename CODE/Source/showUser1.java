...
public class showUser1 extends HttpServlet
{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		uid=req.getParameter("uid");
			...
			pw.println("document.deluser.select1.value='"+(String)v.elementAt(3)+"'} </script></head><P align=center><FONT color=deepskyblue size=4><STRONG>DELETE&nbsp;USER </STRONG></FONT></P> ");
			pw.println("<body onLoad=set()><br><br><form name=deluser method=post action='http://peers:8080/servlet/DelUser'>");
            ...
            pw.println("<TD><INPUT id=text4 name=eid value="+(String)v.elementAt(4)+"><INPUT id=submit1 name=submit1 style='LEFT: 151px; TOP: 318px' type=submit value=Delete></TD></TR>");
