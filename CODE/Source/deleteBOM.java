...
public class deleteBOM extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
			...
			pw.println("<body><P align=center><FONT color=deepskyblue size=4><STRONG>DELETE BILL OF MATERIALS DETAILS</STRONG></FONT></P>");
            pw.println("<form name=delbom method=post action='http://peers:8080/servlet/showBOM1'>");
            v=pr.allProducts();
			v1=p.allParts();
