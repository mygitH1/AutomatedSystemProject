...
public class addBOFM extends HttpServlet
{
    Connection con=null;
	HttpSession hs=null;
	Vector v=new Vector();
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
			...
			pw.println("<body><P align=center><FONT color=deepskyblue size=4><STRONG>ADD BILL OF MATERIALS DETAILS</STRONG></FONT></P>");
            pw.println("<form name=additionbofm method=post action='http://peers:8080/servlet/addBOM'>");
            v=pr.allProducts();
			v1=p.allParts();
		    pw.println("<table align='center' border=0> <tr><td>");
			pw.println("Select Dealer ID</td><td><SELECT id=select1 name=prid style='HEIGHT: 22px; LEFT: 74px; TOP: 222px; WIDTH: 155px'>"); 
			...
			for(i=0;i<v1.size();i++)
     		...
     		pw.println("</SELECT></td></tr><TR><TD>No.Of Parts Required&nbsp;&nbsp;</TD><TD><INPUT id=text2 name=req></TD></TR>");
