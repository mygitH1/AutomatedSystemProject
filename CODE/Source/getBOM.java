...
public class getBOM extends HttpServlet
{
    Connection con=null;
	HttpSession hs=null;
	Vector v=new Vector();
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
			...
			pw.println("<body><P align=center><FONT color=deepskyblue size=4><STRONG>VIEW BILL OF MATERIALS DETAILS</STRONG></FONT></P>");
            pw.println("<form name=viewbom method=post action='http://peers:8080/servlet/viewBOM'>");
            v=pr.allProducts();
			v1=p.allParts();
