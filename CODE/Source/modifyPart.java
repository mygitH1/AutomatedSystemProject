...
public class modifyPart extends HttpServlet
{
    Connection con=null;
	HttpSession hs=null;
	Vector v=new Vector();
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
			...
			pw.println("<body><br><br><br><form name=modifyPart method=post action='http://peers:8080/servlet/showPart')");
            v=P.allParts();
		    pw.println("<table align='center' border=0> <tr><td>");
			pw.println("Select Part ID To Modify</td><td><SELECT id=select1 name=pid style='HEIGHT: 22px; LEFT: 74px; TOP: 222px; WIDTH: 155px'>"); 
