...
public class addPrds extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
			...
			pw.println("<body><P align=center><FONT color=deepskyblue size=4><STRONG>ADD PRODUCT STOCK DETAILS</STRONG></FONT></P><form name=additionPrds method=post action='http://peers:8080/servlet/addProductStock')>");
            v1=pr.allProducts();
			v=d.allDealers();
