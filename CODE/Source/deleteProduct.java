...
public class deleteProduct extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
		    ...
		    pw.println("<body><br><br><br><form name=deleteProduct method=post action='http://peers:8080/servlet/showProduct1')");
        	v=PR.allProducts();
		    pw.println("<table align='center' border=0> <tr><td>");
			pw.println("Select Product ID To Delete</td><td><SELECT id=select1 name=prid style='HEIGHT: 22px; LEFT: 74px; TOP: 222px; WIDTH: 155px'>"); 
