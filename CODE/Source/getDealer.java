...
public class getDealer extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
			...
			pw.println("<body><br><br><br><form name=viewdealer method=post action='http://peers:8080/servlet/viewDealer')");
                        v=D.allDealers();
		        pw.println("<table align='center' border=0> <tr><td>");
			pw.println("Select Dealer Name To Display Details</td><td><SELECT id=select1 name=did style='HEIGHT: 22px; LEFT: 74px; TOP: 222px; WIDTH: 155px'>"); 
