...
public class showProductStock extends HttpServlet
{
    Connection con=null;
	HttpSession hs=null;
    String did;
...
pw.println("<html><head><TITLE>Web-Enabled Automated Manufacturing System</TITLE></script></head><P align=center><FONT color=deepskyblue size=4><STRONG>MODIFY&nbsp;PRODUCT </STRONG></FONT></P> ");
pw.println("<body><form name=updateProductStock method=post action='http://peers:8080/servlet/UpdateProductStock'>");
...
pw.println("<INPUT id=text4 name=rol value="+(String)v.elementAt(3)+"><INPUT id=submit1 style='LEFT: 151px; TOP: 318px' type=submit value=Update name=submit1></TD></TR>");
