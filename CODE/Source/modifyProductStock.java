...
public class modifyProductStock extends HttpServlet
{
    Connection con=null;
	HttpSession hs=null;
	Vector v=new Vector();
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
			...
			pw.println("<body><br><br><br><form name=modifyPrStock method=post action='http://peers:8080/servlet/showProductStock'>");
            v1=pr.allProducts();
			v=d.allDealers();
