...
public class deleteUser extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
		    ...
		    pw.println("<body><br><br><br><form name=deleteyuser method=post action='http://peers:8080/servlet/showUser1')");
        	    v=U.allUsers();
		    pw.println("<table align='center' border=0> <tr><td>");
			pw.println("Select User Name To Delete</td><td><SELECT id=select1 name=uid style='HEIGHT: 22px; LEFT: 74px; TOP: 222px; WIDTH: 155px'>"); 
