...
public class deleteSuppliers extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
		    ...
		    pw.println("<body><br><br><br><form name=deleteSuppliers method=post action='http://peers:8080/servlet/showSuppliers1')");
        	    v=S.allSuppliers();
		    pw.println("<table align='center' border=0> <tr><td>");
			pw.println("Select Suppliers ID To Delete</td><td><SELECT id=select1 name=sid style='HEIGHT: 22px; LEFT: 74px; TOP: 222px; WIDTH: 155px'>"); 
