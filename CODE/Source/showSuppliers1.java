...
public class showSuppliers1 extends HttpServlet
{
    Connection con=null;
	HttpSession hs=null;
    String sid;
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
	 try
	 {
		...
		sid=req.getParameter("sid");
			...
			pw.println("document.delSuppliers.select1.value='"+v.get(4).toString()+"'} </script></head><P align=center><FONT color=deepskyblue size=4><STRONG>DELETE&nbsp;SUPPLIER </STRONG></FONT></P> ");
			pw.println("<body onLoad=set()><form name=delSuppliers method=post action='http://peers:8080/servlet/DelSuppliers'>");
			...
			pw.println("<TR><TD>Supplier Name&nbsp;</TD><TD><INPUT id=text2 name=sname value="+sid+" ></TD></TR><TR><TD>Supplier Address&nbsp;</TD>");
            ...
            pw.println("<TD><INPUT id=text4 name=eid value="+v.get(5).toString()+"><INPUT id=submit1 name=submit1 style='LEFT: 151px; TOP: 318px' type=submit value=Delete></TD></TR>");
